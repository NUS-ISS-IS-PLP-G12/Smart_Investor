...
model_out_dp.add(Embedding(input_dim=36214, output_dim=100,trainable=False))
...
print('Train...')
hist_out_dp = model_out_dp.fit(X, y,
          batch_size=batch_size,
          epochs=3,).history

loss, accuracy = model_out_dp.evaluate(X, y, verbose=True)
...
import pickle as p
with open('LSTM.pickle','wb') as fw:
    p.dump(model_out_dp,fw)
